...
class AgentState(MessagesState):
    ...
    # simplified report (generated after Risk Judge, before END)
    simplified_report: Annotated[Optional[Dict[str, Any]], "Simplified report data for boss-friendly view"]
