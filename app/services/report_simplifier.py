...
class ReportSimplifier:
    ...
    5. 个人看法与风险警示。
    6. 炒作点分析：是否符合A股“故事驱动估值”。
    7. 综合投资建议：不简单说买入/卖出，结合趋势、情绪、时机、布林形态。
    8. 多空双方核心分歧与底层逻辑。
    9. 待办事项 3 条。
    10. 结尾金句。
    ...
    2. 英雄区标题必须显示：超级大脑 · {stock_name} {stock_code}
    3. 英雄区：深蓝色渐变背景，文字白色，包含标题和 executive_summary
    4. 所有内容用卡片式布局，白色背景，圆角
    5. 卡片文字：深灰色 #1e293b
    6. 核心词汇：橙色 #f59e0b 或 深蓝色 #1e40af 加粗
    ...
    8. 适配手机端，使用viewport，禁止缩放滚动
    9. 只返回完整HTML代码，不要任何解释
    10. 确保包含 <!DOCTYPE html>
